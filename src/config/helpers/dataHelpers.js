...
export const sumSalesSubTotal = (sales, clicks) => {
  const _sum = Object.keys(clicks)
    .map((item) => {
      return (
        sales.find((prod) => prod.id === item).minimum_price * clicks[item] || 0
      );
    })
...
export const foodSubCategories = [
  ...
  { category: "Foods", subcategory: "Chips" },
  { category: "Foods", subcategory: "Rice" },
  { category: "Foods", subcategory: "Sauce" },
  { category: "Foods", subcategory: "Cakes" },
  { category: "Foods", subcategory: "Pizza" },
  { category: "Foods", subcategory: "Burgers" },
  { category: "Foods", subcategory: "Bites" },
  { category: "Foods", subcategory: "Pilao" },
  { category: "Foods", subcategory: "Half Chips" },
  { category: "Foods", subcategory: "Half Katogo" },
  { category: "Foods", subcategory: "Special Dishes" },
  { category: "Foods", subcategory: "Local Foods" },

  { category: "Beverages", subcategory: "Milk Shakes" },
  { category: "Beverages", subcategory: "Smoothies" },
  { category: "Beverages", subcategory: "Juices" },
  { category: "Beverages", subcategory: "Teas" },
  { category: "Beverages", subcategory: "Herbal Teas" },
  { category: "Beverages", subcategory: "Coffee" },
  { category: "Beverages", subcategory: "Soft Drinks" },
  { category: "Beverages", subcategory: "Moctails" },
  { category: "Beverages", subcategory: "Cocktails" },
  { category: "Beverages", subcategory: "Bottles" },
  { category: "Beverages", subcategory: "Shots" },
  { category: "Beverages", subcategory: "Beers" },
  { category: "Beverages", subcategory: "Smokes" },
];
...
export const formatSubCategoryAndName = (subCat, foodNam) => {
  // Check if 'a' is a substring of 'b'
  if (foodNam.includes(subCat)) {
    return foodNam;
  } else {
